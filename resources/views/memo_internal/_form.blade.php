    ...
    {!! Form::label('nomor_urut_dokumen', 'Nomor Urut Dokumen', ['class'=>'col-md-4 control-label']) !!}
        <div class = "col-md-5">
            {!! Form::number('nomor_urut_dokumen', null, 
                [
                    'class'=>'form-control',
                    'placeholder'=>'Isi Nomor Urut Dokumen Memo Internal'
                ]) !!}
...
<div class= "form-group{{ $errors->has('no_memo') ? 'has-error': '' }} ">
        {!! Form::label('no_memo', 'Nomor Memo', ['class'=>'col-md-4 control-label']) !!}
        <div class = "col-md-5">
            {!! Form::text('no_memo', null, 
                [
                    'class'=>'form-control',
                    'placeholder'=>'Isi Nomor Memo'
                ]) !!}
            {!! $errors->first('no_memo', '<p class= "help-block">:message</p>') !!}
        </div>
</div> 
