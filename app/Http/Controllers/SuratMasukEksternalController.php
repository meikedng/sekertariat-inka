...
class SuratMasukEksternalController extends Controller
{
    ...
    {
        return $dataTable->render('sm_eksternal.index');
    }
    ...
    public function storeStatus(Request $request, $tujuan_id){
    ...
    public function createStatus($tujuan_id){
        ...
        return view('sm_eksternal.create_status')->with(compact('tujuan_id','is_diserahkan'));
    }

    public function createDisposisi($tujuan_id){
        // apakah sudah pernah diserahkan
        // $is_diserahkan = tStatusTujuanDokumen::where('tujuan_dokumen_id',$tujuan_id)
        //                     ->where('status_tujuan_id',2)->count(); 
        
        return view('sm_eksternal.create_disposisi')->with(compact('tujuan_id','is_diserahkan'));
    }
