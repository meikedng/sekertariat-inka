...
class MemoInternalController extends Controller
{
    ...
    public function create()
    {
        ...
        */
        ...
        return view('memo_internal.create')->with(compact('list_circular','first_dest'));
    }
    ...
    public function edit($id)
    {
        ...
        if(!is_null($unit_id)){
            $memo_internal->pengirim = $unit_id->id;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $dokumen->nomor_referensi = $request->nomor_referensi;
